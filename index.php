...
var seconds = Math.floor(delta  % 60);
    ...
    document.getElementById('time').innerHTML=days + " days <br/>" + hours + " hours <br/>" + minutes + " minutes <br/>" + seconds + " seconds";
    document.getElementById('name').innerHTML=resignationName + " resigned on " + resignationDateS + " at " + resignationTimeS + " " + note;;
